...
(function (e, t) {
    ...
    if (s && U) {
        var ee = function defineWellKnownSymbol(e) {
            ...
            Object.defineProperty(q, e, {configurable: false, enumerable: false, writable: false, value: t});
            return t
        };
    ...
    var He = function (e, t) {
        h(this, {object: e, array: Be(e), kind: t})
    };
    h(He.prototype, {
        next: function next() {
            var e;
    ...
    if (s) {
        var ir = {input: "$_", lastMatch: "$&", lastParen: "$+", leftContext: "$`", rightContext: "$'"};
    ...
    var Or = function () {
        ...
        h(m, {
            "catch": function (e) {
                ...
                var c = new r(o);
                var v = {capabilities: c, handler: Y.IsCallable(e) ? e : a};
                var y = {capabilities: c, handler: Y.IsCallable(t) ? t : u};
                var h = n._promise;
                var g;
                if (h.state === s) {
    ...
    if (s) {
        ...
        var _r = {
            Map: function () {
                ...
                var u = function Map() {
                    ...
                    var e = we(this, Map, a, {_es6map: true, _head: null, _storage: Ar(), _size: 0});
                ...
                var o = function Set() {
                    ...
                    var e = we(this, Set, n, {_es6set: true, "[[SetData]]": null, _storage: Ar()});
                    if (!e._es6set) {
                        throw new TypeError("bad set")
                    }
                    if (arguments.length > 0) {
        ...
        if (j.Map || j.Set) {
            ...
            if (typeof j.Map.prototype.clear !== "function" || (new j.Set).size !== 0 || (new j.Map).size !== 0 || typeof j.Map.prototype.keys !== "function" || typeof j.Set.prototype.keys !== "function" || typeof j.Map.prototype.forEach !== "function" || typeof j.Set.prototype.forEach !== "function" || a(j.Map) || a(j.Set) || typeof(new j.Map).keys().next !== "function" || on || !Xr) {
                h(j, {Map: _r.Map, Set: _r.Set}, true)
            }
        ...
        var ln = function set(e, r, n, o) {
            ...
            if ("value"in i) {
                ...
                if (u) {
                    ...
                    return Z.defineProperty(o, r, {value: n, writable: true, enumerable: true, configurable: true})
                }
            }
            if (i.set) {
                t(i.set, o, n);
